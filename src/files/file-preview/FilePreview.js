...
import DangerIcon from '../../icons/retro/files/DangerIcon'
...
const Preview = (props) => {
  ...
  switch (type) {
    ...
    default: {
      ...
      const cantPreview = (
        <div className='flex flex-column items-center justify-center w95fa white mb3'>
          <div style={{ margin: 'calc(50vh - 200px) auto 5px', width: 'fit-content' }}>
            <DangerIcon />
          </div>
          <p className='mv2 spacegrotesk white'>{t('cantBePreviewed')} <span role='img' aria-label='sad'>😢</span></p>
          <p className='mv2 grayColor tc spacegrotesk' style={{ width: '300px' }}>
            {availableGatewayUrl === publicGateway
              ? <Trans i18nKey='openWithPublicGateway' t={t}>
                Try opening it instead with your <a href={src} download target='_blank' rel='noopener noreferrer' className='link purple'>public gateway</a>.
              </Trans>
              : <Trans i18nKey='openWithLocalAndPublicGateway' t={t}>
                Try opening it instead with your <a href={src} download target='_blank' rel='noopener noreferrer' className='link purple'>local gateway</a> or <a href={srcPublic} download target='_blank' rel='noopener noreferrer' className='link purple'>public gateway</a>.
              </Trans>
            }
