    ...
    <div data-id='SettingsPage' className='mw9 center'>
      ...
      */}
        ...
        : <Box className='mb3 pa3 joyride-settings-customapi'>
          <div className='lh-copy white'>
            ...
            <Trans i18nKey='apiDescription' t={t}>
              <p className='w95fa f6'>If your node is configured with a <a className='link blue' href='https://github.com/ipfs/go-ipfs/blob/master/docs/config.md#addresses' target='_blank' rel='noopener noreferrer'>custom API address</a>, including a port other than the default 5001, enter it here.</p>
            </Trans>
      ...
      <Box className='mb3 pa3 pa2'>
        <div className='lh-copy white'>
          ...
          <Trans i18nKey='publicGatewayDescription' t={t}>
            <p className='w95fa f6'>Choose which <a className='link blue' href="http://docs.ipfs.io/concepts/ipfs-gateway/#public-gateways" target='_blank' rel='noopener noreferrer'>public gateway</a> you want to use to open your files.</p>
          </Trans>
          <PublicGatewayForm />
        </div>
      </Box>
      ...
      <Box className='mb3 pa3 pa2 joyride-settings-pinning'>
        ...
        <p className='ma0 mr2 lh-copy w95fa white f6'>
        ...
        (<Box className='mb3 pa3 pa2'>
          <div className='joyride-settings-config'>
            ...
            <div className='flex pb3'>
              ...
              {config ? (
                <div className='flex flex-column justify-center flex-row-l items-center'>
                  ...
                  <div className='flex flex-column justify-center items-center'>
                    <RetroButton
                      ...
                      onClick={onReset}>
                      <RetroText color={isSaving || (!hasLocalChanges && !hasExternalChanges) ? '#9C9C9C' : '#000'}>
                        {t('app:actions.reset')}
                      </RetroText>
                    </RetroButton>
                    <SaveButton
...
const SaveButton = ({ t, hasErrors, hasSaveFailed, hasSaveSucceded, isSaving, hasLocalChanges, hasExternalChanges, onClick }) => {
  ...
  return (
    <RetroButton
      ...
      onClick={onClick}>
      <RetroText color={!hasLocalChanges || hasErrors ? '#9C9C9C' : '#000'}>
...
const SettingsInfo = ({ t, isIpfsConnected, isConfigBlocked, hasExternalChanges, hasSaveFailed, hasSaveSucceded, isLoading, config }) => {
  if (isConfigBlocked) {
    return (
      <p className='ma0 lh-copy w95fa white f6 mw7'>
    ...
    return (
      <p className='ma0 lh-copy w95fa red f6 mw7'>
    ...
    return (
      <p className='ma0 lh-copy w95fa red fw6 f5 mw7'>
        {t('errorOccured')}
    ...
    return (
      <p className='ma0 lh-copy w95fa green fw6 f6 mw7'>
        {t('changesSaved')}
